...
<br /><br />
Loss value for manual calculation ( first listing in exercise_1_29_04_2026_micrograd_.ipynb file  ) - final loss  tensor(0.1116)
<br /><br />
...
<br /><br />
Tiny fake flower dataset - these are simply 4 examples with 2 features each, and described classes 0 and 1. That's all for now. <b>The goal was to make something small enough that it could be easily to develop and easy to understand basic calculations.</b>
<br /><br />
// 29.04.2026
